...
def train(args):
    ...
    # print(tokenizer.decode(train_dataset[0][0][-1]))
    # print(tokenizer.decode(train_dataset[0][2][-1]))
    # sys.exit("bye")
...
if __name__ == "__main__":
    ...
    ###############################################################################################
    # MLFLOW parameters
    parser.add_argument("--use_mlflow", type=str, default=None)
    parser.add_argument("--mlflow_experiment_name", type=str, default="ilgeeh-nemo-aws-batch")
