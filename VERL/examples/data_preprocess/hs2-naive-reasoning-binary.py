...
from prompt_templates import NaiveReasoningBinaryPromptTemplate

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--local_dir', default='~/data/hs2-naive-reasoning-binary')
    parser.add_argument('--skip_idx_dir', default='VERL/skip-indices/hs2-naive-reasoning-binary')
    ...
    def make_map_fn(split):
        ...
        def process_fn(example, idx):
            ...
            solution = "A" if example['preference_strength'] < 0 else "B"
            data = {
