...
##########################################################################################
PROJECT_NAME=think_genrm_grpo_naive-binary
BASE_MODEL=ilgee/hs2-naive-binary-max-ep5-lr1e-5
EPOCH=1
KL_COEF=1e-4
LR=2e-6
ROLLOUT_SIZE=512
...
python3 VERL/examples/data_preprocess/hs2-naive-reasoning-binary.py --local_dir ~/data/hs2-naive-reasoning-binary
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$HOME/data/hs2-naive-reasoning-binary/train.parquet \
    data.val_files=$HOME/data/hs2-naive-reasoning-binary/test.parquet \
    data.train_batch_size=$ROLLOUT_SIZE \
    data.max_prompt_length=4096 \
    data.max_response_length=4096 \
    data.filter_overlong_prompts=True \
    data.truncation=error \
    custom_reward_function.path=verl/utils/reward_score/naive-reasoning-binary.py \
